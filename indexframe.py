...
class IndexFrame(QtGui.QWidget):
    ...
    def __init__(self, parent, dry_run):
        ...
        activefilters = namedtuple('activefilters', 'title description tags wordcount')
        self.active_filters = activefilters(* 4 * (None,)) 
...
class Terminal(GenericTerminal):
    ...
    def __init__(self, parent, get_tags):
        ...
        # These two are set in reload_settings() in mneme.py
        self.rootpath = ''
        self.tagmacros = {}
        self.commands = {
